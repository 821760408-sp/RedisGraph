...
typedef enum {
    TIME = 1, LOCAL_TIME = 2, DATE = 4, DATE_TIME = 8, LOCAL_DATE_TIME = 16
} RG_TemporalType;
...
int RG_TemporalValue_GetYear(RG_TemporalValue timeValue);
int RG_TemporalValue_GetQuarter(RG_TemporalValue timeValue);
...
// int RG_TemporalValue_GetOffsetMinuets(RG_TemporalValue temporalValue);
// int RG_TemporalValue_GetOffsetSeconds(RG_TemporalValue temporalValue);
// int RG_TemporalValue_GetEpochMillis(RG_TemporalValue temporalValue);
// int RG_TemporalValue_GetEpochSeconds(RG_TemporalValue temporalValue);
